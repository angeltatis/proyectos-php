...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            <h4 class="text-center">Datos del Suplidor</h4>
        </div>
        <div class="card">
            <div class="card-body">
                <form method="post">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label>Nombre</label>
                                <input type="text" name="nom_proveedor" id="nom_proveedor" class="form-control" placeholder="Ingrese nombre del proveedro" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="dir_proveedor" id="dir_proveedor" class="form-control" disabled required>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input id="cantidad" class="form-control" type="text" name="cantidad" placeholder="Cantidad" onkeyup="calcularPrecio_compra(event)">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
        ...
        <div class="table-responsive">
            <table class="table table-hover" id="tblDetalle_compra">
