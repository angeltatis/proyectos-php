...
const navigation = [
    ...
    { name: 'Poducto', href: '/producto', current: false },
    { name: 'Consulta', href: '/consulta', current: false },
    { name: 'Conficuracion', href: '/config', current: false },
]
</script>
<template>
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            <router-link v-for="item in navigation" :key="item.name" :to="item.href"
                                :class="[item.current ? 'router-link-active' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'rounded-md px-3 py-2 text-sm font-medium']"
